    ...
    <SafeAreaView style={tw`p-4 android:pt-2  flex-1 bg-slate-200 relative`}>
      <View style={tw`flex-4 pt-[5rem] flex-column gap-4 justify-center`}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("s3")}
        >
          <Text style={tw`text-white font-semibold`}>Unusual discharge</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={tw`bg-[#3742FA] p-4 px-6 rounded-full w-full`}
          onPress={() => navigation.navigate("s3")}
        >
          <Text style={tw`text-white font-semibold`}>Heavy menstrual flow</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={tw`bg-[#3742FA] p-4 px-6 rounded-full w-full`}
          onPress={() => navigation.navigate("s3")}
        >
          <Text style={tw`text-white font-semibold`}>Mood swings</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={tw`flex-1 items-center`}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("s5")}
        >
